...
from sfr_box_core.discovery import DiscoveredBox, async_discover_boxes, _DiscoveryListener
...
def mock_async_zeroconf():
    ...
    with patch('sfr_box_core.discovery.AsyncZeroconf', return_value=mock_aiozc) as mock_aiozc_class:
...
async def test_discover_single_box_async(mock_async_zeroconf, monkeypatch):
    ...
    monkeypatch.setattr('sfr_box_core.discovery.AsyncServiceBrowser', lambda *args, **kwargs: mock_browser)
...
async def test_discover_multiple_boxes_async(mock_async_zeroconf, monkeypatch):
    ...
    monkeypatch.setattr('sfr_box_core.discovery.AsyncServiceBrowser', lambda *args, **kwargs: MagicMock(async_cancel=AsyncMock()))
